...
export default function WeddingWebsite() {
  ...
  // Link to view all photos (your Cloudinary media library)
  const PHOTO_VIEW_URL = 'https://console.cloudinary.com/console/c-' + CLOUDINARY_CLOUD_NAME + '/media_library';
  ...
  const EVENTS = [
    {
      ...
      mapUrl: 'https://www.google.com/maps/place/Neha+Enterprises/@26.1484055,85.3947537,17z',
  ...
  return (
    <div className="min-h-screen bg-[#FDF6E9] text-stone-800" style={{ fontFamily: '"Cormorant Garamond", "Tiro Devanagari Hindi", serif' }}>
      ...
      <section id="home" className="relative pt-24 sm:pt-28 min-h-screen flex items-center mandala-bg paper-texture overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 text-center relative z-10">
          ...
          <div className="fade-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="font-hindi text-base sm:text-xl text-stone-700 mt-6">{WEDDING.groom.name} &nbsp;◆&nbsp; {WEDDING.bride.name}</div>
          </div>
      ...
      <section id="story" className="py-20 sm:py-28 px-4 sm:px-6 bg-gradient-to-b from-[#FDF6E9] to-amber-50/40">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-16 grid sm:grid-cols-3 gap-6 text-left">
            {[
              { icon: '✨', titleEn: 'How we met', titleHi: 'पहली मुलाक़ात', bodyEn: 'Two families connected through shared friends in Muzaffarpur. The first meeting felt like home.', bodyHi: 'मुजफ्फरपुर में दो परिवार साझे मित्रों के माध्यम से जुड़े।' },
              { icon: '👰🤵', titleEn: 'A New Beginning', titleHi: 'नई शुरुआत', bodyEn: 'With the blessings of their families, Prakash and Priya are ready to begin this beautiful journey together.', bodyHi: 'परिवारों के आशीर्वाद के साथ, प्रकाश और प्रिया अब अपनी नई जिंदगी की शुरुआत करने जा रहे हैं।' },
          ...
          {!rsvpSubmitted ? (
            ...
            <div className="bg-white border-2 border-emerald-300 rounded-2xl p-8 text-center shadow-md">
              ...
              <p className="font-serif-display text-stone-700 leading-relaxed">
                {rsvp.attending === 'yes' ? `We can't wait to celebrate with you, ${rsvp.name}!` : `Thank you for letting us know, ${rsvp.name}. We'll miss you. 💛`}
              </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="bg-white border border-amber-200 rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-2 text-sm text-stone-700">
                <div><strong>Muzaffarpur Jn (MFP)</strong> — main station</div>
                <div><strong>Patna Jn (PNBE)</strong> — for wedding day</div>
                <div><strong>Hajipur Jn (HJP)</strong> — alternate, 40 km</div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-rose-50 to-amber-50 border border-amber-200 rounded-2xl p-6 shadow-sm">
              ...
              <div className="text-sm text-stone-700 space-y-1">
                <div><strong>Auto/Rickshaw:</strong> Plenty available</div>
      ...
      <footer className="bg-gradient-to-b from-[#FDF6E9] to-red-900 text-amber-100 py-12 px-4 mt-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="font-script text-4xl gold-shimmer mb-2">{WEDDING.groom.nameEn} &amp; {WEDDING.bride.nameEn}</div>
          ...
          <p className="text-xs text-amber-300/80 font-serif-display">Made with love by the Mehta family · {WEDDING.hashtag}</p>
          <p className="font-hindi text-xs text-amber-300/80 mt-1">मेहता परिवार द्वारा प्रेम से निर्मित</p>
        </div>
